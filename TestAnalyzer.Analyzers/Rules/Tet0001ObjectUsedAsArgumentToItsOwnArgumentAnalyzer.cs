...
namespace TestAnalyzer.Analyzers.Rules
{
    ...
    public class Tet0001ObjectUsedAsArgumentToItsOwnArgumentAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString s_description = "Detects calls like 'obj.Foo(obj)' or extension/static calls like 'Foo(obj, obj)'. Usually this is a typo biak. Changes from PR 5.";
